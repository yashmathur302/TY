...
@section('title', 'Friends Forever – EduConnect')
...
<div class="max-w-[1065px] mx-auto">
    ...
    <div class="bg-white shadow lg:rounded-b-2xl lg:-mt-10 dark:bg-dark2">
        ...
        <div class="relative overflow-hidden w-full lg:h-72 h-36">
            <img src="https://picsum.photos/seed/groupcover/1200/500" alt="Friends Forever cover" class="h-full w-full object-cover inset-0">
            ...
            <div class="lg:space-y-4 lg:pb-8 max-lg:grid sm:grid-cols-2 max-lg:gap-6"
                ...
                <div class="box p-5 px-6">
                    ...
                    <ul class="text-gray-700 space-y-4 mt-2 mb-1 text-sm dark:text-white/80">
                        <li>This is a public group for people who love connecting, sharing ideas, and building friendships.</li>
