...
<div class="max-w-[1065px] mx-auto">
    ...
    <div class="flex 2xl:gap-12 gap-10 mt-8 max-lg:flex-col" id="js-oversized">
        ...
        <div class="flex-1 xl:space-y-6 space-y-3">
            ...
            <!-- Empty feed state -->
            <div class="bg-white rounded-xl shadow-sm p-10 text-center dark:bg-dark2">
                <ion-icon name="chatbubble-ellipses-outline" class="text-5xl text-gray-300 dark:text-white/20 mb-3"></ion-icon>
                <p class="text-gray-400 dark:text-white/40 font-normal text-sm">No posts yet. Be the first to share something with this group!</p>
            </div>
