<header class="site-header z-[100] h-[--m-top] fixed top-0 left-0 w-full flex items-center bg-white/80 sky-50 backdrop-blur-xl border-b border-slate-200 dark:bg-dark2 dark:border-slate-800">
    ...
    <div class="header-inner flex items-center w-full xl:px-6 px-2 max-lg:gap-10">
        ...
        <div class="header-logo-wrap 2xl:w-[--w-side] lg:w-[--w-side-sm]">
            <div class="header-logo flex items-center gap-1">
                ...
                <div id="logo">
                    <a href="{{ route('feed') }}">
                        <img src="{{ asset('assets/images/logo.png') }}" alt="EduConnect Logo" class="w-28 md:block hidden dark:!hidden">
                        <img src="{{ asset('assets/images/logo-light.png') }}" alt="EduConnect Logo" class="dark:md:block hidden">
                        <img src="{{ asset('assets/images/logo-mobile.png') }}" alt="EduConnect Logo" class="hidden max-md:block w-20 dark:!hidden">
                        <img src="{{ asset('assets/images/logo-mobile-light.png') }}" alt="EduConnect Logo" class="hidden dark:max-md:block w-20">
                    </a>
                </div>
        ...
        <div class="header-right flex-1 relative">
            <div class="max-w-[1220px] mx-auto flex items-center">
                ...
                <!-- Search Dropdown -->
                <div class="search-dropdown hidden uk-open z-10"
                    ...
                    <div class="xl:w-[694px] sm:w-96 bg-white dark:bg-dark3 w-screen p-2 rounded-lg shadow-lg -mt-14 pt-14">
                        ...
                        <nav class="search-recent-list text-sm font-medium text-black dark:text-white">
                            <a href="#" class="search-recent-item relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10">
                                <img src="{{ asset('assets/images/avatars/avatar-2.jpg') }}" class="w-9 h-9 rounded-full" alt="Jesse Steeve">
                                <div>
                            ...
                            <a href="#" class="search-recent-item relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10">
                                <img src="{{ asset('assets/images/avatars/avatar-2.jpg') }}" class="w-9 h-9 rounded-full" alt="Martin Gray">
                                <div>
                                    <div>Martin Gray</div>
                                    <div class="text-xs text-blue-500 font-medium mt-0.5">Friend</div>
                                </div>
                            ...
                            <a href="#" class="search-recent-item relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10">
                                <img src="{{ asset('assets/images/group/group-2.jpg') }}" class="w-9 h-9 rounded-full" alt="Delicious Foods">
                                <div>
                            ...
                            <a href="#" class="search-recent-item relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10">
                                <img src="{{ asset('assets/images/group/group-1.jpg') }}" class="w-9 h-9 rounded-full" alt="Delicious Foods">
                                <div>
                                    <div>Delicious Foods</div>
                            ...
                            <a href="#" class="search-recent-item relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10">
                                <img src="{{ asset('assets/images/avatars/avatar-6.jpg') }}" class="w-9 h-9 rounded-full" alt="John Welim">
                                <div>
                                    <div>John Welim</div>
                                    <div class="text-xs text-blue-500 font-medium mt-0.5">Friend</div>
                                </div>
                ...
                <div class="header-icons flex items-center sm:gap-4 gap-2 absolute right-5 top-1/2 -translate-y-1/2 text-black">
                    ...
                    <div class="create-dropdown hidden bg-white p-4 rounded-lg overflow-hidden drop-shadow-xl dark:bg-slate-700 md:w-[324px] w-screen border2"
                            ...
                            <div class="uk-slider-container pb-1">
                                <ul class="uk-slider-items grid-small" uk-scrollspy="target: > li; cls: uk-animation-scale-up , uk-animation-slide-right-small; delay: 20 ;repeat: true">
                                    <li class="w-28" uk-scrollspy-class="uk-animation-fade">
                                        <div class="create-item create-item--story p-3 px-4 rounded-lg bg-teal-100/60 text-teal-600 dark:text-white dark:bg-dark4">
                                            <ion-icon name="book" class="text-2xl drop-shadow-md"></ion-icon>
                                            <div class="mt-1.5 text-sm font-medium">Story</div>
                                        </div>
                                    </li>
                                    <li class="w-28">
                                        <div class="create-item create-item--post p-3 px-4 rounded-lg bg-sky-100/60 text-sky-600 dark:text-white dark:bg-dark4">
                                            <ion-icon name="camera" class="text-2xl drop-shadow-md"></ion-icon>
                                            <div class="mt-1.5 text-sm font-medium">Post</div>
                                        </div>
                                    </li>
                                    <li class="w-28">
                                        <div class="create-item create-item--reel p-3 px-4 rounded-lg bg-purple-100/60 text-purple-600 dark:text-white dark:bg-dark4">
                                            <ion-icon name="videocam" class="text-2xl drop-shadow-md"></ion-icon>
                                            <div class="mt-1.5 text-sm font-medium">Reel</div>
                                        </div>
                                    </li>
                                    <li class="w-28">
                                        <div class="create-item create-item--location p-3 px-4 rounded-lg bg-pink-100/60 text-pink-600 dark:text-white dark:bg-dark4">
                                            <ion-icon name="location" class="text-2xl drop-shadow-md"></ion-icon>
                                            <div class="mt-1.5 text-sm font-medium">location</div>
                                        </div>
                                    </li>
                                    <li class="w-28">
                                        <div class="create-item create-item--status p-3 px-4 rounded-lg bg-sky-100/70 text-sky-600 dark:text-white dark:bg-dark4">
                        ...
                        <ul class="create-links -m-1 mt-4 pb-1 text-xs text-gray-500 dark:text-white" uk-scrollspy="target: > li; cls: uk-animation-scale-up , uk-animation-slide-bottom-small ;repeat: true">
                            <li class="flex items-center gap-4 hover:bg-secondery rounded-md p-1.5 cursor-pointer dark:hover:bg-white/10">
                                <img src="{{ asset('assets/images/icons/group.png') }}" alt="Groups" class="w-7">
                                <div class="flex-1">
                                    <a href="#"><h4 class="font-medium text-sm text-black dark:text-white">Groups</h4></a>
                                    <div class="mt-1 text-xs text-gray-500 dark:text-white">Meet people with similar interests.</div>
                                </div>
                            </li>
                            <li class="flex items-center gap-4 hover:bg-secondery rounded-md p-1.5 cursor-pointer dark:hover:bg-white/10">
                                <img src="{{ asset('assets/images/icons/page.png') }}" alt="Pages" class="w-7">
                                <div class="flex-1">
                                    <a href="#"><h4 class="font-medium text-sm text-black dark:text-white">Pages</h4></a>
                                    <div class="mt-1">Find and connect with businesses.</div>
                                </div>
                            </li>
                            <li class="flex items-center gap-4 hover:bg-secondery rounded-md p-1.5 cursor-pointer dark:hover:bg-white/10">
                                <img src="{{ asset('assets/images/icons/event.png') }}" alt="Event" class="w-7">
                                <div class="flex-1">
                                    <a href="#"><h4 class="font-medium text-sm text-black dark:text-white">Event</h4></a>
                                    <div class="mt-1">Discover fun activities near you.</div>
                                </div>
                            </li>
                            <li class="flex items-center gap-4 hover:bg-secondery rounded-md p-1.5 cursor-pointer dark:hover:bg-white/10">
                                <img src="{{ asset('assets/images/icons/market.png') }}" alt="Market" class="w-8 -ml-1">
                                <div class="flex-1">
                                    <a href="#"><h4 class="font-medium text-sm text-black dark:text-white">Market</h4></a>
                                    <div class="mt-1">Find local buyers and sellers.</div>
                                </div>
                            </li>
                            <li class="flex items-center gap-4 hover:bg-secondery rounded-md p-1.5 cursor-pointer dark:hover:bg-white/10">
                                <img src="{{ asset('assets/images/icons/game.png') }}" alt="Games" class="w-7">
                                <div class="flex-1">
                                    <a href="#"><h4 class="font-medium text-sm text-black dark:text-white">Games</h4></a>
                    ...
                    <button type="button" class="header-notif-btn sm:p-2 p-1 rounded-full relative sm:bg-secondery dark:text-white" uk-tooltip="title: Notification; pos: bottom; offset:6">
                            ...
                            <div class="pl-2 p-1 text-sm font-normal dark:text-white">
                                ...
                                <a href="#" class="notif-item notif-item--unread relative flex items-center gap-3 p-2 duration-200 rounded-xl pr-10 hover:bg-secondery dark:hover:bg-white/10 bg-teal-500/5">
                                    <div class="notif-avatar relative w-12 h-12 shrink-0">
                                        <img src="{{ asset('assets/images/avatars/avatar-3.jpg') }}" alt="Alexa Gray" class="object-cover w-full h-full rounded-full">
                                    </div>
                                ...
                                <a href="#" class="notif-item relative flex items-center gap-3 p-2 duration-200 rounded-xl pr-10 hover:bg-secondery dark:hover:bg-white/10">
                                    <div class="notif-avatar relative w-12 h-12 shrink-0">
                                        <img src="{{ asset('assets/images/avatars/avatar-7.jpg') }}" alt="Jesse Steeve" class="object-cover w-full h-full rounded-full">
                                    </div>
                                    <div class="notif-content flex-1">
                                ...
                                <a href="#" class="notif-item relative flex items-center gap-3 p-2 duration-200 rounded-xl pr-10 hover:bg-secondery dark:hover:bg-white/10">
                                    <div class="notif-avatar relative w-12 h-12 shrink-0">
                                        <img src="{{ asset('assets/images/avatars/avatar-6.jpg') }}" alt="Alexa Stella" class="object-cover w-full h-full rounded-full">
                                    </div>
                                    <div class="notif-content flex-1">
                                ...
                                <a href="#" class="notif-item relative flex items-center gap-3 p-2 duration-200 rounded-xl pr-10 hover:bg-secondery dark:hover:bg-white/10">
                                    <div class="notif-avatar relative w-12 h-12 shrink-0">
                                        <img src="{{ asset('assets/images/avatars/avatar-2.jpg') }}" alt="John Michael" class="object-cover w-full h-full rounded-full">
                                    </div>
                                    <div class="notif-content flex-1">
                                ...
                                <a href="#" class="notif-item notif-item--unread relative flex items-center gap-3 p-2 duration-200 rounded-xl pr-10 hover:bg-secondery dark:hover:bg-white/10 bg-teal-500/5">
                                    <div class="notif-avatar relative w-12 h-12 shrink-0">
                                        <img src="{{ asset('assets/images/avatars/avatar-3.jpg') }}" alt="Sarah Gray" class="object-cover w-full h-full rounded-full">
                                    </div>
                                    <div class="notif-content flex-1">
                                ...
                                <a href="#" class="notif-item relative flex items-center gap-3 p-2 duration-200 rounded-xl pr-10 hover:bg-secondery dark:hover:bg-white/10">
                                    <div class="notif-avatar relative w-12 h-12 shrink-0">
                                        <img src="{{ asset('assets/images/avatars/avatar-4.jpg') }}" alt="Jesse Steeve" class="object-cover w-full h-full rounded-full">
                                    </div>
                                    <div class="notif-content flex-1">
                                        <p><b class="font-bold mr-1">Jesse Steeve</b> sarah tagged you in a photo of your birthday party. 📸</p>
                                        <div class="notif-time text-xs text-gray-500 mt-1.5 dark:text-white/80">8 hours ago</div>
                                    </div>
                                </a>
                                ...
                                <a href="#" class="notif-item relative flex items-center gap-3 p-2 duration-200 rounded-xl pr-10 hover:bg-secondery dark:hover:bg-white/10">
                                    <div class="notif-avatar relative w-12 h-12 shrink-0">
                                        <img src="{{ asset('assets/images/avatars/avatar-2.jpg') }}" alt="Lewis Lewis" class="object-cover w-full h-full rounded-full">
                                    </div>
                                    <div class="notif-content flex-1">
                                ...
                                <a href="#" class="notif-item relative flex items-center gap-3 p-2 duration-200 rounded-xl pr-10 hover:bg-secondery dark:hover:bg-white/10">
                                    <div class="notif-avatar relative w-12 h-12 shrink-0">
                                        <img src="{{ asset('assets/images/avatars/avatar-7.jpg') }}" alt="Martin Gray" class="object-cover w-full h-full rounded-full">
                                    </div>
                                    <div class="notif-content flex-1">
                    ...
                    <!-- Messages Button -->
                    <button type="button" class="header-msg-btn sm:p-2 p-1 rounded-full relative sm:bg-secondery dark:text-white" uk-tooltip="title: Messages; pos: bottom; offset:6">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 max-sm:hidden">
                            ...
                            <div class="p-2 pt-0 pr-1 dark:text-white/80">
                                ...
                                <a href="#" class="msg-item relative flex items-center gap-4 p-2 py-3 duration-200 rounded-lg hover:bg-secondery dark:hover:bg-white/10">
                                    <div class="msg-avatar relative w-10 h-10 shrink-0">
                                        <img src="{{ asset('assets/images/avatars/avatar-2.jpg') }}" alt="Jesse Steeve" class="object-cover w-full h-full rounded-full">
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center gap-2 mb-1">
                                            ...
                                            <div class="msg-unread-dot w-2.5 h-2.5 bg-blue-600 rounded-full dark:bg-slate-700"></div>
                                        </div>
                                ...
                                <a href="#" class="msg-item relative flex items-center gap-4 p-2 py-3 duration-200 rounded-lg hover:bg-secondery dark:hover:bg-white/10">
                                    <div class="msg-avatar relative w-10 h-10 shrink-0">
                                        <img src="{{ asset('assets/images/avatars/avatar-4.jpg') }}" alt="Martin Gray" class="object-cover w-full h-full rounded-full">
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center gap-2 mb-1">
                                ...
                                <a href="#" class="msg-item relative flex items-center gap-4 p-2 py-3 duration-200 rounded-lg hover:bg-secondery dark:hover:bg-white/10">
                                    <div class="msg-avatar relative w-10 h-10 shrink-0">
                                        <img src="{{ asset('assets/images/avatars/avatar-5.jpg') }}" alt="Jesse Steeve" class="object-cover w-full h-full rounded-full">
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center gap-2 mb-1">
                                            <div class="mr-auto text-sm text-black dark:text-white font-medium">Jesse Steeve</div>
                                ...
                                <a href="#" class="msg-item relative flex items-center gap-4 p-2 py-3 duration-200 rounded-lg hover:bg-secondery dark:hover:bg-white/10">
                                    <div class="msg-avatar relative w-10 h-10 shrink-0">
                                        <img src="{{ asset('assets/images/avatars/avatar-3.jpg') }}" alt="Monroe Parker" class="object-cover w-full h-full rounded-full">
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center gap-2 mb-1">
                                ...
                                <a href="#" class="msg-item relative flex items-center gap-4 p-2 py-3 duration-200 rounded-lg hover:bg-secondery dark:hover:bg-white/10">
                                    <div class="msg-avatar relative w-10 h-10 shrink-0">
                                        <img src="{{ asset('assets/images/avatars/avatar-7.jpg') }}" alt="Alex Dolve" class="object-cover w-full h-full rounded-full">
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center gap-2 mb-1">
                    ...
                    <div class="header-profile rounded-full relative bg-secondery cursor-pointer shrink-0">
                        <img src="{{ asset('assets/images/avatars/avatar-2.jpg') }}" alt="Profile" class="sm:w-9 sm:h-9 w-7 h-7 rounded-full shadow shrink-0">
                    </div>
                    ...
                    <div class="profile-dropdown hidden bg-white rounded-lg drop-shadow-xl dark:bg-slate-700 w-64 border2"
                        ...
                        <a href="#">
                            <div class="profile-dropdown-user p-4 py-5 flex items-center gap-4">
                                <img src="{{ asset('assets/images/avatars/avatar-2.jpg') }}" alt="Stell Johnson" class="w-10 h-10 rounded-full shadow">
                                <div class="flex-1">
                            ...
                            <button type="button" class="w-full">
                                <div class="flex items-center gap-2.5 hover:bg-secondery p-2 px-2.5 rounded-md dark:hover:bg-white/10">
                                    ...
                                    <span class="night-mode-toggle bg-slate-200/40 ml-auto p-0.5 rounded-full w-9 dark:hover:bg-white/20">
                                        <span class="night-mode-knob bg-white block h-4 relative rounded-full shadow-md w-2 w-4 dark:bg-blue-600"></span>
                                    </span>
                                </div>
                            </button>
